        ...
        <section class="col-9">
            ...
            <div class="tab-content">
                <div class="tab-pane container-fluid <?php if(isset($_POST['save']) || isset($_POST['update']) || (!isset($_POST['add_image']) && !isset($_POST['delete_image']))): ?>active<?php endif; ?>" id="infos" role="tabpanel">
                    ...
                    <form action="index.php?page=administration&admin=article" method="post" enctype="multipart/form-data">
                ...
                <?php if(isset($article)): ?>
                    <div class="tab-pane container-fluid <?php if(isset($_POST['add_image']) || isset($_POST['delete_image'])): ?>active<?php endif; ?>" id="images" role="tabpanel">
                        ...
                        <form action="index.php?page=administration&admin=article&article_id=<?php echo $article['id']; ?>&action=edit" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <?php  while($image = $query->fetch()):?>
                                <form action="index.php?page=administration&admin=article&article_id=<?php echo $article['id']; ?>&action=edit" method="post" class="col-4 my-3">
